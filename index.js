...
document.addEventListener("DOMContentLoaded", function() {
    const metaMaskSection = document.getElementById("Meta_Mask_h");
    
    metaMaskSection.addEventListener("click", async () => {
        ...
        if (typeof window.ethereum !== "undefined") {
            ...
            try {
                ...
                // Call your wallet interaction functions here
                // For example, sending transactions, querying balances, etc.
            } catch (error) {
